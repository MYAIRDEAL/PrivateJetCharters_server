...
// Swagger documentation route
router.use('/api/admin/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerDocument));
...
/** Modify Schema Routes */
router.get("/modifycategory", modifyController.getModifyCategories);
router.post("/addmodifycategory", upload.single("image"), modifyController.addModifyCategories);
router.put("/editmodifycharterbyid/:id", upload.single("image"), modifyController.editModifyCharterById);
router.delete("/deletemodifycharterbyid/:id", modifyController.deleteModifyCharterById);

/** Sub Categories Routes */
router.get("/getallsubcategories", modifyController.getSubCategories);
router.post("/addsubcategory", upload.single("image"), modifyController.addSubCategories);
router.put("/editmodifysubcharterbyid/:id", upload.single("image"), modifyController.editSubCategoryById);
router.delete("/deletemodifysubcharterbyid/:id", modifyController.deleteModifySubCharterById);
